...
export const ProgressRadarModal: React.FC<ProgressRadarModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-3 sm:p-4 backdrop-blur-lg animate-in fade-in duration-200">
      <div className="liquid-glass-card rounded-3xl w-full max-w-xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden border border-[#A89178]/25">
        {/* Header */}
        <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-[#A89178]/15 shrink-0">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-xl bg-white/10 border border-[#A89178]/25 shadow-xs">
              <Sparkles className="w-4 h-4 text-[#BA9F7F]" />
            </div>
            <div>
              <h2 className="text-sm sm:text-base font-bold text-[#FFFDF8] tracking-tight">
                Workout Progress Radar
              </h2>
              <p className="text-[11px] text-[#B8A696]">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-4 sm:space-y-5 custom-glass-scrollbar">
          ...
          <div className="flex flex-col items-center justify-center relative select-none">
            ...
            >
              <defs>
                ...
                <radialGradient
                  ...
                  fy="50%"
                >
                  <stop offset="0%" stopColor="#BA9F7F" stopOpacity="0.55" />
                  <stop offset="70%" stopColor="#A89178" stopOpacity="0.35" />
                  <stop offset="100%" stopColor="#6E5843" stopOpacity="0.18" />
                </radialGradient>
                  ...
                  <g key={axis.id}>
                    ...
                    <text
                      ...
                      className={`text-[10px] sm:text-[11px] font-semibold cursor-pointer transition-colors ${
                        isSelected
                          ? "fill-[#BA9F7F] font-bold"
                          : "fill-[#FAF5EE] hover:fill-[#BA9F7F]"
                      }`}
                    >
                      ...
                      <tspan
                        x={labelCoord.x}
                        dy="1.2em"
                        className="text-[9px] font-bold fill-[#B0987F]"
                      >
                        {axis.score}%
                      </tspan>
                    </text>
            ...
            {selectedAxis && (
              <div className="mt-2 text-center text-xs px-3 py-1.5 rounded-xl bg-white/10 border border-[#A89178]/20 animate-in fade-in duration-150">
                <span className="font-bold text-[#FFFDF8]">
                  {selectedAxis.name}
                </span>
                <span className="text-[#B8A696] ml-2">
          ...
          <div className="space-y-2.5 pt-1">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#D0C0B0] px-1 flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-2.5">
              ...
              <div className="liquid-glass-pill rounded-2xl p-3 sm:p-3.5 space-y-1.5 border border-[#A89178]/20 shadow-xs">
                <div className="flex items-center gap-1.5 text-[#BA9F7F]">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-[#B8A696] leading-tight">
                    {analytics.recommendations.progressiveOverload.message}
                  </p>
                  <p className="text-[11px] text-[#B0987F] font-semibold leading-tight pt-0.5">
                    ⚡{" "}
                    {
              ...
              <div className="liquid-glass-pill rounded-2xl p-3 sm:p-3.5 space-y-1.5 border border-[#A89178]/20 shadow-xs">
                <div className="flex items-center gap-1.5 text-[#B0987F]">
