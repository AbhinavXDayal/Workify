    ...
    <div className="w-full max-w-full flex flex-col flex-1 min-h-0 transition-all duration-200">
      ...
      >
        {groupedSlots.map((group, groupIdx) => (
          ...
          >
            {/* Muscle Group Title with soft faded accent indicator */}
            <div
              className={`flex items-center gap-1.5 px-1 ${
                isWed ? "pb-0 sm:pb-0.5" : "pb-0.5 sm:pb-0.5"
              }`}
            >
              <span className="w-1.5 h-1.5 rounded-full bg-[#7E9A88]" />
              <h3 className="text-[9px] sm:text-[10.5px] font-semibold text-[#CCD6CF] tracking-wider uppercase select-none leading-none">
                {group.name}
              </h3>
            </div>
                    ...
                    <>
                      ...
                      >
                        <input
                          ...
                          className="w-0 flex-1 min-w-0 bg-transparent text-right text-[11.5px] sm:text-sm text-[#FFFFFF] font-semibold placeholder-[#58665E] focus:outline-none font-mono pr-0.5"
                        />
                        <span className="text-[9.5px] sm:text-xs text-[#859D8E] font-bold select-none shrink-0 pointer-events-none ml-0.5">
                          kg
                        </span>
                      </div>
