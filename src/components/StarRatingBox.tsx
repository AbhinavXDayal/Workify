...
export const StarRatingBox: React.FC<StarRatingBoxProps> = ({
  ...
  return (
    <div
      ...
      className="relative w-[124px] sm:w-[204px] md:w-[236px] h-[38px] sm:h-10 hazy-input rounded-xl sm:rounded-2xl flex items-center justify-center gap-1 sm:gap-2 px-1.5 sm:px-2 shrink-0 select-none transition-all duration-150"
